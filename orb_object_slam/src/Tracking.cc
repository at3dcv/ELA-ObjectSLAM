...
{
	std::cout << "---GrabImageMonocular: 1" << std::endl;
	mImRGB = im;
	mImGray = im;
	...
	std::cout << "---GrabImageMonocular: 2" << std::endl;
	Track(); // main code here
	std::cout << "---GrabImageMonocular: 3" << std::endl;

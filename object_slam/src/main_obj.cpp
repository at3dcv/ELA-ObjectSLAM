...
{  
	...
	// AC: Instantiate detect_3d_cuboid class
	...
	// AC: Instantiate line descriptor
	// AC: https://docs.opencv.org/master/dc/ddd/group__line__descriptor.html
    ...
    for (int frame_index=0;frame_index<total_frame_number;frame_index++)
    {
	  ...
	  {
		// AC: take the last pointer to a frame and extract its cam_pose_Tcw value
